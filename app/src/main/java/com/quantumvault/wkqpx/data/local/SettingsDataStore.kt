package com.quantumvault.wkqpx.data.local
...
class SettingsDataStore(private val context: Context) {
    ...
    companion object {
        ...
        private val TWO_FACTOR_AUTH_ENABLED_KEY = booleanPreferencesKey("two_factor_auth_enabled")
    ...
    val settingsFlow: Flow<VaultSettings> = context.dataStore.data.map { prefs ->
        VaultSettings(
            ...
            isTwoFactorAuthEnabled = prefs[TWO_FACTOR_AUTH_ENABLED_KEY] ?: false,
    ...
    suspend fun setTwoFactorAuthEnabled(enabled: Boolean) {
        context.dataStore.edit { prefs ->
            prefs[TWO_FACTOR_AUTH_ENABLED_KEY] = enabled
        }
    }
