    ...
    fun showPrompt(
        ...
        val callback = object : BiometricPrompt.AuthenticationCallback() {
            ...
            override fun onAuthenticationFailed() {
                ...
                // Do not dismiss or terminate prompt on transient sensor mismatch; Android BiometricPrompt allows retries
                android.util.Log.w("BiometricPromptManager", "Biometric authentication attempt failed (sensor mismatch), user can retry")
            }
        }
